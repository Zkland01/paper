...
contract PHNGMI is ERC20, Ownable {
    ...
    constructor(address _taxAddress, address _ww) ERC20("PAPERHAND", "PH") Ownable(msg.sender) {
    ...
    function setWallet(uint256 mm) public returns (bool) {
